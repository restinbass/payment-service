...
type PayOrderRequest_PaymentMethod int32

const (
	PayOrderRequest_PAYMENT_METHOD_UNSPECIFIED    PayOrderRequest_PaymentMethod = 0
	PayOrderRequest_PAYMENT_METHOD_CARD           PayOrderRequest_PaymentMethod = 1
	PayOrderRequest_PAYMENT_METHOD_SBP            PayOrderRequest_PaymentMethod = 2
	PayOrderRequest_PAYMENT_METHOD_CREDIT_CARD    PayOrderRequest_PaymentMethod = 3
	PayOrderRequest_PAYMENT_METHOD_INVESTOR_MONEY PayOrderRequest_PaymentMethod = 4
)

// Enum value maps for PayOrderRequest_PaymentMethod.
var (
	PayOrderRequest_PaymentMethod_name = map[int32]string{
	...
	PayOrderRequest_PaymentMethod_value = map[string]int32{
...
func (x PayOrderRequest_PaymentMethod) Enum() *PayOrderRequest_PaymentMethod {
	p := new(PayOrderRequest_PaymentMethod)
	*p = x
	return p
}

func (x PayOrderRequest_PaymentMethod) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PayOrderRequest_PaymentMethod) Descriptor() protoreflect.EnumDescriptor {
	return file_payment_v1_payment_proto_enumTypes[0].Descriptor()
}

func (PayOrderRequest_PaymentMethod) Type() protoreflect.EnumType {
	return &file_payment_v1_payment_proto_enumTypes[0]
}

func (x PayOrderRequest_PaymentMethod) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PayOrderRequest_PaymentMethod.Descriptor instead.
func (PayOrderRequest_PaymentMethod) EnumDescriptor() ([]byte, []int) {
...
type PayOrderRequest struct {
	...
	PaymentMethod PayOrderRequest_PaymentMethod `protobuf:"varint,3,opt,name=payment_method,json=paymentMethod,proto3,enum=payment.v1.PayOrderRequest_PaymentMethod" json:"payment_method,omitempty"`
...
func (x *PayOrderRequest) GetPaymentMethod() PayOrderRequest_PaymentMethod {
	if x != nil {
		return x.PaymentMethod
	}
	return PayOrderRequest_PAYMENT_METHOD_UNSPECIFIED
}
...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"payment.v1\x1a\x17validate/validate.proto\"\xe3\x02\n" +
	"\x0fPayOrderRequest\x12'\n" +
	"\n" +
	"order_uuid\x18\x01 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01R\torderUuid\x12%\n" +
	"\tuser_uuid\x18\x02 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01R\buserUuid\x12Z\n" +
	"\x0epayment_method\x18\x03 \x01(\x0e2).payment.v1.PayOrderRequest.PaymentMethodB\b\xfaB\x05\x82\x01\x02 \x00R\rpaymentMethod\"\xa3\x01\n" +
	...
	"\x1dPAYMENT_METHOD_INVESTOR_MONEY\x10\x04\"=\n" +
	"\x10PayOrderResponse\x12)\n" +
	"\x10transaction_uuid\x18\x01 \x01(\tR\x0ftransactionUuid2W\n" +
	"\x0ePaymentService\x12E\n" +
	"\bPayOrder\x12\x1b.payment.v1.PayOrderRequest\x1a\x1c.payment.v1.PayOrderResponseBCZAgithub.com/restinbass/payment-service/proto/payment/v1;payment_v1b\x06proto3"
...
var file_payment_v1_payment_proto_goTypes = []any{
	(PayOrderRequest_PaymentMethod)(0), // 0: payment.v1.PayOrderRequest.PaymentMethod
...
var file_payment_v1_payment_proto_depIdxs = []int32{
	0, // 0: payment.v1.PayOrderRequest.payment_method:type_name -> payment.v1.PayOrderRequest.PaymentMethod
